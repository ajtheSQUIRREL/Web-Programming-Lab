          ...
          <div className="overflow-y-auto" style={{ maxHeight: "24rem" }}>
            <ul className="p-6 space-y-6">
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Hridoy</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Hasan</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Abrar</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Hasib</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Firoz</span>
                <span className="ml-auto font-semibold">8.2</span>
              </li>
              <li className="flex items-center">
                <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                ...
                <span className="text-gray-600">Hossain</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Shourav</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Sojun</span>
